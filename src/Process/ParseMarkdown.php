...
class ParseMarkdown
{
    ...
    protected readonly array $specialCharacters = [
        '\\',
        '`',
        '*',
        '_',
    ...
    protected readonly array $StrongRegex = [
        '*' => '/^[*]{2}((?:\\\\\*|[^*]|[*][^*]*[*])+?)[*]{2}(?![*])/s',
    ...
    private function setSafeMode($safeMode)
    {
    ...
    protected function blockCodeComplete(array $Block)
    {
